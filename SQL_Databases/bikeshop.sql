...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2021 at 12:19 PM
...
(2, 'Kasha', 'Todd', NULL, 'xxxxxx', '910 Vine Street ', 'Campbell', 'CA', '95008'),
(3, 'Tameka', 'Fisher', NULL, 'xxx', '769C Honey Creek St. ', 'Redondo Beach', 'CA', '90278'),
(4, 'Daryl', 'Spence', NULL, 'daryl.spence@aol.com', '988 Pearl Lane ', 'Uniondale', 'NY', '11553'),
(5, 'Charolette', 'Rice', '(916) 381-6003', 'GGGGGGGGG', '107 River Dr. ', 'Sacramento', 'CA', '95820'),
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`staff_id`) REFERENCES `staffs` (`staff_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `staffs`
  ...
  ADD CONSTRAINT `staffs_ibfk_2` FOREIGN KEY (`manager_id`) REFERENCES `staffs` (`staff_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
